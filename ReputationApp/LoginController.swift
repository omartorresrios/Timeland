...
class LoginController: UIViewController, GIDSignInDelegate, GIDSignInUIDelegate {
    ...
    func saveApiTokenInKeychain(tokenString: String, idInt: Int, nameString: String, emailString: String) {
            ...
            case .success(let upload, _, _):
                ...
                upload.responseJSON { response in
                    ...
                    if let JSON = response.result.value as? NSDictionary {
                        ...
                        print("JSON: \(JSON)")
                        self.saveApiTokenInKeychain(tokenString: authToken, idInt: userId, nameString: userName, emailString: userEmail)
